...
public class VerifyCodeUtil {
	...
	public static final String DEFAULT_VERIFY_CODES = "23456789ABCDEFGHJKLMNPQRSTUVWXYZ";
	...
	public static String generateVerifyCode(int verifySize) {
		return generateVerifyCode(verifySize, DEFAULT_VERIFY_CODES);
	}
